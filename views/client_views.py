...
def deliveries_handler():
    ...
    deliveries, response_status = delivery.get_user_deliveries( user_id, { 'send_date': send_date,
    ...
    return render_template('deliveries.html', all=True, deliveries=deliveries, search_options=search_options, return_page_url='/'), response_status
...
def delivey_handler(delivery_id):
    ...
    delivery_details, response_status = delivery.get_delivery_info(delivery_id, user_id)
    ...
    return render_template('deliveries.html', all=False, delivery=delivery_details, client=client_info, driver=driver_info, manager=manager_info, transport=transport_info, return_page_url='/delivery/'), response_status
